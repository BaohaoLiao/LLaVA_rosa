...
class LoraLayer(BaseTunerLayer):
    ...
    def update_layer(
        ...
        self.lora_A[adapter_name] = nn.Linear(self.out_features, 2, bias=False)
        self.lora_B[adapter_name] = nn.Linear(self.out_features, 2, bias=False)
    ...
    def _apply_rosa(self, x, lora_A, lora_B):
        lora_A_cos = lora_A.weight[0].cos()
        lora_A_sin = lora_A.weight[1].sin()
        lora_B_cos = lora_B.weight[0]
        lora_B_sin = lora_B.weight[1]


        lora_A_cos = lora_B_cos * lora_A_cos
        lora_A_sin = lora_B_sin * lora_A_sin
